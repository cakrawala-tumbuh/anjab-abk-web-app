...
async function fetchReferenceData(accessToken: string | undefined) {
  ...
  // Ketiganya mengisi dropdown formulir tambah partisipan — kegagalannya tidak
  // boleh tampil sebagai "master data belum diisi".
  if (!sekolahRes.data) throw apiErrorDari(sekolahRes);
  if (!jabatanRes.data) throw apiErrorDari(jabatanRes);
  if (!mataPelajaranRes.data) throw apiErrorDari(mataPelajaranRes);
