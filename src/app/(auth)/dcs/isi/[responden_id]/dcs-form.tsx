...
interface Props {
   ...
   * ada responden yang tersentuh. Dipakai halaman `/dcs/demo` agar admin bisa
   * mencontohkan cara pengisian tanpa mengotori data studi.
   */
  demo?: boolean;
}

export function DcsForm({
  respondenId,
  subskala,
  jawabanAwal,
  sudahSubmit,
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-8">
      {demo && (
        ...
        >
          <strong>Mode Demo.</strong> Halaman ini hanya memperagakan cara pengisian kuesioner DCS.
