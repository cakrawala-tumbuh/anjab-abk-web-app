# SOP Persiapan — WCP (Workplace Climate/Characteristics Profile)
...
WCP (**Workplace Climate / Characteristics Profile**) mengukur iklim dan karakteristik
tempat kerja. Instrumen terdiri dari **12 dimensi** dengan total **72 item pernyataan**.
Setiap dimensi diklasifikasikan sebagai **Dimensi Risiko** atau **Dimensi Protektif**.
...
### 1. Tinjau instrumen WCP

1. Buka **Master Data → Instrumen WCP**.
2. Tinjau ke-12 dimensi (perhatikan label **Dimensi risiko** / **Dimensi protektif**) dan
...
## Daftar Periksa (Checklist) Persiapan WCP
