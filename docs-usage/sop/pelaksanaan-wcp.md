...
Prosedur baku menjalankan pengambilan data kuesioner **WCP** — dari membuka sesi hingga
hasil tersedia.
...
```
Buka Sesi → daftar responden → partisipan isi kuesioner (72 item)
...
> Langkah teknis: [IK-07 bagian B–C](../ik/wcp.md#b-membuka-menutup-sesi).
...
2. Tiap responden membuka **Kuesioner Saya** → kartu **WCP** → **Isi Sekarang**, menjawab
   seluruh 72 item pada skala **1–5**, lalu **Kirim Jawaban**.

> Langkah teknis: [IK-07 bagian D](../ik/wcp.md#d-mengisi-kuesioner-partisipan).
...
> Langkah teknis: [IK-07 bagian B](../ik/wcp.md#b-membuka-menutup-sesi).
