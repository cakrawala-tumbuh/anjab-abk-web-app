# SOP Pelaksanaan — WCP (Workplace Climate/Characteristics Profile)

Prosedur baku menjalankan pengambilan data kuesioner **WCP** — dari menugaskan responden
hingga hasil tersedia.

**Tujuan:** mengumpulkan jawaban 72 item WCP dari responden yang tepat secara lengkap.

**Penanggung jawab:** Administrator studi.

**Prasyarat:** [SOP Persiapan WCP](persiapan-wcp.md) telah selesai.

**Langkah teknis:** [IK-07 WCP](../ik/wcp.md).
...
```
Tugaskan responden → partisipan isi kuesioner (72 item)
...
1. Buka halaman **WCP** (status **Terbuka** sejak awal — tidak perlu dibuka manual).
...
> Langkah teknis: [IK-07 bagian C](../ik/wcp.md#c-menugaskan-responden).
...
2. Tiap responden membuka **Kuesioner Saya** → kartu **WCP** → **Isi Sekarang**, menjawab
   seluruh 72 item pada skala **1–5**, lalu **Kirim Jawaban**. Progres dapat disimpan
   sewaktu-waktu lewat **Simpan** sebelum finalisasi.

> Langkah teknis: [IK-07 bagian E](../ik/wcp.md#e-mengisi-kuesioner-partisipan).
...
Pantau dari halaman **WCP**: kartu status menampilkan jumlah responden yang sudah mengisi
...
> Langkah teknis: [IK-07 bagian B & D](../ik/wcp.md#b-aksi-instrumen).
...
## Daftar Periksa (Checklist) Pelaksanaan WCP
...
- [ ] Hasil (skor per dimensi & interpretasi) diverifikasi di `/wcp/hasil`
